...
Hard Accuracy: 49.62% Submissions: 29622 Points: 8
...
class Solution
{
    ...
    Node *copyList(Node *head)
    {
        ...
        // created new nodes for each node
        while(cur){
            temp=cur->next;
        ...
        // pointing all arbitaries nodes from new nodes
        while(cur){
            if(cur->arb){
        ...
        //now removing the old links and making new links
        // og->og
        // copy->copy
        Node * og=head;
        Node *copy=head->next;
