...
class Solution
{
    ...
    void removeLoop(Node* head)
    {
        ...
        // 1 exception-"when btoh slow and fast point to head"
        // iska matlab circular linked list hai
        // iss case mein bas fast ko aage badhao aur jab fast= slow ho jaaye
        // tab usko NULL krdo
        if(slow==head){
        ...
        // issme slow ko head pe krdo aur
        // dono ko ek se increment kroo jab dono ka next same aajaye
        // tab fast ka next null krdo
