...
int countRev (string s)
{
    ...
    for(int i=0;i<n;i++){
        if(s[i]=='{'){
            ...
            if(ocnt!=0 and s[i]=='}'){ // yahan pe basicaly ye horha hai ki
                                       // jaise hi opening ke baad closing aarha hai
                  ocnt--;              // toh ek pair form horhaa hai aur hum openin ke
                                       //count ko decrement krdrngr kyunki balance hogya hai
