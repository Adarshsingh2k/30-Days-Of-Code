/**
 * Binary Tree to DLL 
Hard Accuracy: 41.34% Submissions: 68669 Points: 8
...
class Solution
{
    ...
    void inorder(Node *root,Node* &head,Node*&prv, int &idx){
        if(!root)return;
        
        inorder(root->left,head,prv,idx);
        ...
        inorder(root->right,head,prv,idx);
    }
